...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    Row(
                      children: [
                        AnimatedContainer(
                          ...
                          curve: Curves.fastLinearToSlowEaseIn,
                          width:
                              index == _currentIndex ? dimensWidth() * 6.5 : 0,
                        ),
                        AnimatedOpacity(
                    ...
                    Row(
                      children: [
                        AnimatedContainer(
                          ...
                          curve: Curves.fastLinearToSlowEaseIn,
                          width:
                              index == _currentIndex ? dimensWidth() * 1.5 : 20,
                        ),
                        FaIcon(
                          _pageDetail[index]['icon'],
                          size: dimensWidth() * 3.8,
                          color:
                              index == _currentIndex ? primary : Colors.black26,
                        )
                      ],
                    ),
                  ],
      ...
      body: _pageDetail[_currentIndex]['page'],
    );
  }
}
// NavigationBar(
...
//                 _selectedPage = value;
//               }),
//           destinations: _pageDetail
//               .map((e) =>
//                   NavigationDestination(icon: e['icon'], label: e['title']))
//               .toList()),