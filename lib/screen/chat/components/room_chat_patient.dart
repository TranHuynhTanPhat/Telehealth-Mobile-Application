...
class RoomChatPatient extends StatefulWidget {
  const RoomChatPatient(
      {super.key, required this.detail});
  final RoomChat detail;

  @override
  State<RoomChatPatient> createState() => _RoomChatPatientState();
}

class _RoomChatPatientState extends State<RoomChatPatient> {
                  ...
                  child: Stack(
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            "${translate(context, 'dr')}. ${widget.detail.doctor?.fullName ?? translate(context, 'empty')}",
